...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::content_registry::create_content_type,
            commands::content_registry::update_content_type,
            commands::content_registry::set_content_type_archived,
            commands::content_registry::restore_default_content_types,

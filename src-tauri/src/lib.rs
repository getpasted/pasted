...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::search_indexes::list_search_history,
            commands::search_indexes::record_search_history,
            commands::search_indexes::delete_search_history,
            commands::search_indexes::clear_search_history,
            commands::search_indexes::enforce_search_history_retention,
            ...
            commands::about::open_backing_page,

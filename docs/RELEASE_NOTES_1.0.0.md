...
- Pinning, explicit and inherited Bin protection, per-clip paste shortcuts, notes, Trash, revisions, Activity, Full Backup and Restore, and portable History and Organization import

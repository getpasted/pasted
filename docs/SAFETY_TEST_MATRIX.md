...
| Release artifacts | Each packaged payload receives a Syft-generated SPDX SBOM and license-policy audit in addition to the deterministic 420-component distributed-software SBOM. |

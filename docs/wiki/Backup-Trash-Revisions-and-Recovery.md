...
Transfer files include clips in History and Trash, notes, pins, explicit protection, clip hotkeys, Bins and ordering, inherited Bin-protection settings, custom Operations, manual and assisted Transforms, Bin bindings, and OCR lifecycle metadata.

...
pasted extractor create [--name <name>] [--description <text>] --executable <path> [--model <path>] [--input <contract>] [--output <contract>] [--priority <number>] [--enabled|--disabled] [--json]

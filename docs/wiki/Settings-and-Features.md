...
Clip Types, Content Types, and Sources organize the library rather than running Analyzer participants. The sidebar keeps structural Text, Image, and Files filters separate from detected Content Types. Disabling Content Types or Sources hides its related presentation while preserving metadata; Clip Types remain visible.

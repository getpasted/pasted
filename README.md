...
- Analyzes clips locally through bounded Inspect, Extract, Classify, and Enrich passes, with native macOS OCR, editable Detectors, content-free structural metadata, and Smart Action recommendations.

...
export const CLI_COMMAND_GROUPS = [
  {
    ...
    commands: [
      ...
      { usage: 'pasted search [query] [--clip TYPE] [--content TYPE] [--format FORMAT] [--source APP] [--ids ID,...] [--trash] [--limit N] [--offset N] [--json]', get description() { return translate('component.helpView.searchABoundedPageOfHistoryOrTrashWithCollectionFilters'); } },
      { usage: 'pasted search-history list|delete|clear [arguments] [--json]', get description() { return translate('component.helpView.listAndManageSavedSearchHistory'); } },
      ...
      { usage: 'pasted retention [--count N] [--days N] [--trash-count N] [--trash-days N] [--log-count N] [--log-days N] [--revision-count N] [--search-count N] [--json]', get description() { return translate('component.helpView.readOrUpdateHistoryTrashActivityAndRevisionRetention'); } },

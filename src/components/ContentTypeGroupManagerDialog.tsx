...
export function ContentTypeGroupManagerDialog({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return <><AppDialog isOpen={isOpen} onClose={onClose} labelledBy="content-type-group-manager-title" panelClassName="theme-panel flex max-h-[86vh] w-full max-w-2xl flex-col overflow-hidden border">
    {({ requestClose }) => <>

...
const EXPORT_DATA: ReadonlyArray<{
  ...
  { id: 'settings', label: 'Settings and Application Data', description: 'Settings, hotkeys, App Exclusion rules, Queue state, and connection configuration.', formats: ['backup'] },

  ...
  switch (cmd) {
    ...
    case 'get_library_items': {
      ...
      const items = [
        ...
        { stableRef: 'inspector:ffprobe-media-v1', kind: 'inspector', name: 'Media Metadata', description: 'Reads bounded audio and video metadata locally with ffprobe.', groupLabel: 'Content Analysis', icon: 'FileAudio', enabled: null, isBuiltin: true, isArchived: false, sortOrder: 10, revision: 1, inputContract: 'file_references', outputContract: 'media_metadata', analysisPass: 'inspect', createdAt: '', updatedAt: '', capabilities: { canEdit: false, canDuplicate: false, canDelete: false, canDisable: false, canRestore: false } },

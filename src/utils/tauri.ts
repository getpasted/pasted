  ...
  switch (cmd) {
    ...
    case 'get_library_items': {
      ...
      const items = [
        ...
        { stableRef: 'enricher:smart-actions-v1', kind: 'enricher', name: 'Smart Actions', description: 'Recommends saved Transforms from content-free analysis signals.', groupLabel: 'Content Analysis', icon: 'Lightbulb', enabled: null, isBuiltin: true, isArchived: false, sortOrder: 0, revision: 1, inputContract: 'analyzable_text+classification+structural_metadata', outputContract: 'recommendations', analysisPass: 'enrich', participantContract: { stableRef: 'enricher:smart-actions-v1', name: 'Smart Actions', pass: 'enrich', priority: 0, requires: ['analyzable_text', 'classification', 'structural_metadata'], provides: ['recommendations'] }, typeRelations: [], createdAt: '', updatedAt: '', capabilities: { canEdit: false, canDuplicate: false, canDelete: false, canDisable: false, canRestore: false } },

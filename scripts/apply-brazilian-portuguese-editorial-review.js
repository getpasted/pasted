...
const overrides = {
  ...
  'component.welcomeBackupRestore.chooseAPastedFullBackupFile': 'Escolha um backup completo do Pasted (.pastedbackup).',
  'component.welcomeBackupRestore.chooseBackup': 'Escolher backup…',
  'component.welcomeBackupRestore.pastedFullBackup': 'Backup completo do Pasted',
  ...
  'component.welcomeSetup.restoreAPastedFullBackupOrImportClipboardHistory': 'Restaure um backup completo do Pasted ou importe o histórico da área de transferência de praticamente qualquer lugar.',

...
const overrides = {
  ...
  'component.welcomeBackupRestore.chooseAPastedFullBackupFile': 'Elige una copia de seguridad completa de Pasted (.pastedbackup).',
  'component.welcomeBackupRestore.chooseBackup': 'Elegir copia de seguridad…',
  'component.welcomeBackupRestore.pastedFullBackup': 'Copia de seguridad completa de Pasted',
  ...
  'component.welcomeSetup.restoreAPastedFullBackupOrImportClipboardHistory': 'Restaura un backup completo de Pasted o importa el historial del portapapeles desde casi cualquier lugar.',

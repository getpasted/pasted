...
const overrides = {
  ...
  'component.welcomeBackupRestore.chooseAPastedFullBackupFile': 'יש לבחור גיבוי מלא של Pasted‏ (.pastedbackup).',
  'component.welcomeBackupRestore.chooseBackup': 'בחירת גיבוי…',
  'component.welcomeBackupRestore.pastedFullBackup': 'גיבוי מלא של Pasted',
  ...
  'component.welcomeSetup.restoreAPastedFullBackupOrImportClipboardHistory': 'אפשר לשחזר גיבוי מלא של Pasted או לייבא את היסטוריית הלוח כמעט מכל מקום.',

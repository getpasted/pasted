...
const sizeRatchets = new Map([
  ...
  ['src-tauri/src/content_extraction/post_processing_tests.rs', 60],
  ['src-tauri/src/content_extraction/recipe_compatibility.rs', 90],
  ...
  ['src-tauri/src/db/clip_search.rs', 415],
  ['src-tauri/src/db/clip_search/parser.rs', 121],
  ...
  ['src/components/AppShellView.tsx', 300],
  ['src/components/ClipListContent.tsx', 220],
  ['src/components/VirtualClipList.tsx', 160],
  ['src/utils/virtualClipList.ts', 70],
  ...
  ['src-tauri/src/extractor_recipe/post_processing.rs', 140],
  ...
  ['src/components/ExtractorPostProcessingEditor.tsx', 90],
  ['src/components/extractorPostProcessingModel.ts', 30],
  ...
  ['src/mocks/browser/extractorRecipes.ts', 35],

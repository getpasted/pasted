...
const testPairs = [
  ...
  { name: 'Cool - Code Text vs Surface', fg: '#25252a', bg: '#eef0f4', minRatio: 4.5, scheme: 'Cool' },
  ...
  // DARK SCHEME PAIRS
  { name: 'Dark Mode - Primary Button Text vs BG', fg: '#ffffff', bg: '#0066cc', minRatio: 4.5, scheme: 'Dark' },
